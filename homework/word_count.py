...
def line_preprocessing(sequence):
    """Line Preprocessing"""
    # String.punctuation contiene todos los signos de puntuación y lo que hace
    # es eliminarlo de la cadena de texto. El método translate() se utiliza para
    # reemplazar los caracteres en la cadena de texto.
